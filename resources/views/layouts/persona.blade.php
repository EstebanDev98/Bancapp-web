...
<style>
    ...
    .highlight {
            color: #ff9900; /* Color para destacar */
    }
    ...
    .stars i {
            color: #007bff; /* Azul para estrellas */
    }
    ...
    <div class="row">
        ...
        <nav class="col-md-2 sidebar">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('inicio_persona')}}"><i class="fas fa-user me-2"></i>  Perfil</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('principal_persona')}}"> <i class="fas fa-cog me-1"></i>  Menu Principal</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('transferir_persona')}}"> <i class="fas fa-exchange-alt me-1"></i>  Transferencias</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('retiro_persona')}}"> <i class="fas fa-wallet me-1"></i>  Retiros</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('credito_persona')}}"> <i class="fas fa-question-circle me-1"></i>  Creditos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"> <i class="fas fa-file-alt me-1"></i>   Extractos</a>
                </li>
            </ul>
        </nav>
        @yield('content')
